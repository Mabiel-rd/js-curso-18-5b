...
require('colors')
//Importamos el paquete por default de node par manejar archivos fs
const fs = require('fs');
const path =require('path');

//Guardamos el path a nuestro archivo task.json 
const filePath = path.join(__dirname, '../db/task.join');

//Funcion para cargar task desde task.json       find relared code in javascript-18-5B
const loadTask = () => {
   let listTask = {};
